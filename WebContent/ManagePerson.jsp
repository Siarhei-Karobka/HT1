    ...
    <table align="center" border="1" width="90%">
        ...
        <tr>
            ...
            <td>
                ...
                <%out.println(phone);%>
                <a href="<%=request.getContextPath()%>/?action=editPhone&id=<%=person.getId()%>">Редактировать</a>
                <a href="<%=request.getContextPath()%>/?action=deletePhone&id=<%=person.getId()%>">Удалить</a>
                <br>
                <%
                    }
                %>
        ...
        <tr>
            <td colspan="2" align="center">
                ...
                <br>
                <a href="<%=request.getContextPath() + "/home"%>">Вернуться к списку</a>
            </td>
        </tr>
