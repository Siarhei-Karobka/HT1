    ...
    <table align="center" border="1" width="70%">
        ...
        <tr>
            ...
            <td colspan="2">
                ...
                <a href="<%=request.getContextPath()%>/?action=editPhoneNumber&id=<%=person.getId()%>&phone_id=<%=pair.getKey()%>">Редактировать</a>
                <a href="<%=request.getContextPath()%>/?action=deletePhoneNumber&id=<%=person.getId()%>&phone_id=<%=pair.getKey()%>">Удалить</a>
                <br/>
                ...
                <a href="<%=request.getContextPath()%>/?action=addPhoneNumber&id=<%=person.getId()%>">Добавить</a>
            </td>
        </tr>
